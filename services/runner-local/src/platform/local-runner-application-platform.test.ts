...
const runnerId = fixtureRunnerId;
const credential = fixtureCredential;
const imageDigest = fixtureImageDigest;
const configuration = fixtureApplicationConfiguration;
const trustedImages = fixtureTrustedImages;
